...
-- Base de datos para probar los ejercicios ---

CREATE DATABASE EjerciciosTuto; 

Use EjerciciosTuto; 

-- Ejercicio del punto 3 del documento EXCEL 
...
--********Primer problema*******
 ...
 -- Ejercicio del punto 4 del .Excel
...
-- *****Segundo problema*****
 ...
 -- Ejercicio del punto 5 del .Excel
 ...
 -- Ejercicio del punto 6 del .Excel
 ...
 -- Ejercicio del punto 7 del .Excel
 ...
 -- Ejercicio del punto 8 del .Excel ---> Operadores relacionales
 ...
 -- Ejercicio del punto 9 del .Excel ---> Borrar registros (delete)
 -- *** Primer problema****
 ...
 select * from articulos;
  ...
  -- Ejercicio del punto 10 del .Excel ---> Actualizar registros (update)
 ...
 -- Ejercicio del punto 12 del .Excel ---> Valores null (is null)
 ...
 select * from peliculas;
  ...
  -- Ejercicio del punto 13 del .Excel ---> Clave primaria
 ...
 create table alumnos(
  ...
  primary key(legajo)  -- No permite dos claves primaria por lo tanto da error --- 
 );

 create table alumnos(  -- Se crea la tabla otra vez pero de manera correcta --
  legajo varchar(4) not null,
  documento varchar(8),
  nombre varchar(30),
  domicilio varchar(30),
 ...
 -- Ejercicio del punto 14 del .Excel ---> Campo con atributo Identity
 ...
 -- Ejercicio del punto 15 del .Excel ---> otras caracteristicas del atributo identity
 ...
 -- Ejercicio del punto 16 del .Excel ---> truncate table 
 ...
 select * from articulos;
  ...
  -- Ejercicio del punto 18 del .Excel ---> tipo de dato texto
...
-- ****Segundo problema ****
 ...
 -- Ejercicio del punto 19 del .Excel ---> tipo de dato numerico
 ...
 -- Ejercicio del punto 20 del .Excel ---> tipo de dato (fecha y hora)
 ...
 -- Ejercicio del punto 21 del .Excel ---> Ingresar algunos campos (insert into)
 ...
 -- Ejercicio del punto 22 del .Excel ---> Valores por defecto (default)
 ...
 -- Ejercicio del punto 23 del .Excel ---> Columnas calculadas (operadores aritméticos y de concatenación)
 ...
 select * from articulos;
  ...
  -- Ejercicio del punto 24 del .Excel ---> Alias
 ...
 -- Ejercicio del punto 27 del .Excel ---> Funciones para el uso de fechas y horas
 ...
 -- Ejercicio del punto 28 del .Excel ---> ordenar registros (order by)
 ...
 -- Ejercicio del punto 29 del .Excel --->  Operadores lógicos ( and - or - not)
 ...
 delete from peliculas
  ...
  -- Ejercicio del punto 30 del .Excel --->  Otros operadores relacionales (is null)
 ...
 -- Ejercicio del punto 31 del .Excel --->  Otros operadores relacionales (between)
 ...
 -- Ejercicio del punto 32 del .Excel --->  Otros operadores relacionales (in)
 ...
 -- Ejercicio del punto 33 del .Excel --->  Búsqueda de patrones (like - not like)
 ...
 -- Ejercicio del punto 34 del .Excel --->   Contar registros (count)
 ...
 -- Ejercicio del punto 35 del .Excel --->   Funciones de agrupamiento (count - sum - min - max - avg)
 ...
 select avg(cantidadhijos)
  ...
  -- Ejercicio del punto 36 del .Excel --->    Agrupar registros (group by)
 ...
 -- Ejercicio del punto 37 del .Excel --->   Seleccionar grupos (having)
 ...
 -- Ejercicio del punto 38 del .Excel --->  Registros duplicados (distinct)
...
-- ****Segundo problema****
 ...
 -- Ejercicio del punto 39 del .Excel --->  Cláusula top
 ...
 -- Ejercicio del punto 40 del .Excel --->   Eliminar restricciones (alter table - drop)
 ...
 -- Ejercicio del punto 42 del .Excel --->   Eliminar restricciones (alter table - drop)
 ...
 -- Ejercicio del punto 43 del .Excel --->   Combinación externa izquierda (left join)
 ...
 -- Ejercicio del punto 44 del .Excel --->   Combinación externa derecha (right join)
 ...
 select c.nombre,domicilio,ciudad, p.nombre
  ...
  -- Ejercicio del punto 45 del .Excel --->   Combinación externa completa (full join)
 ...
 -- Ejercicio del punto 46 del .Excel --->   Combinaciones cruzadas (cross join)
 ...
 -- Ejercicio del punto 47 del .Excel --->   Combinación de más de dos tablas
 ...
 -- Ejercicio del punto 50 del .Excel --->   Union
 ...
 -- Ejercicio del punto 51 del .Excel --->  Agregar y eliminar campos ( alter table - add - drop)
 ...
 -- Ejercicio del punto 52 del .Excel --->  Alterar campos (alter table - alter)
 ...
 sp_columns empleados;-- No se puede --
 ...
 alter table empleados
  alter column legajo int identity;  -- No se puede agregar este atributo -- 
 ...
 -- Ejercicio del punto 53 del .Excel --->  Campos calculados
 ...
 update articulos set montototal=300 where descripcion='birome';
  ...
  -- Ejercicio del punto 55 del .Excel --->  Subconsultas como expresión
 ...
 -- Ejercicio del punto 56 del .Excel --->  Subconsultas con in
 ...
 -- Ejercicio del punto 57 del .Excel --->   Subconsultas any - some - all
 ...
 -- Ejercicio del punto 58  del .Excel --->   Subconsultas correlacionadas
 ...
 -- Ejercicio del punto 59  del .Excel --->  Subconsulta - Exists y Not Exists
 ...
 -- Ejercicio del punto 60  del .Excel --->  Subconsulta en lugar de una tabla
 ...
 -- Ejercicio del punto 61  del .Excel --->  Subconsulta (update - delete)
 ...
 -- Ejercicio del punto 62  del .Excel --->  Subconsulta (insert)
 ...
 -- Ejercicio del punto 63  del .Excel --->  Crear tabla a partir de otra (select - into)
 ...
 select *from sucursalCordoba;
  ...
  -- Ejercicio del punto 65  del .Excel ---> vistas
 ...
 -- Ejercicio del punto 67  del .Excel ---> Lenguaje de control de flujo (case)
 ...
 -- Ejercicio del punto 68 del .Excel ---> Lenguaje de control de flujo (if)
...
-- *** Primer problema****
 ...
 -- Ejercicio del punto 70 del .Excel ---> Procedimientos almacenados (crear - ejecutar)
...
if object_id('empleados') is not null
 ...
 -- Ejercicio del punto 73 del .Excel ---> Funciones escalares (crear y llamar)
...
-- Ejercicio del punto 74 del .Excel ---> Funciones de tabla de varias instrucciones
